...
4. **Bring a laptop and charger** to the session. Your computer should have at least 4 GB of RAM and 4 GB of storage.
...
All materials in this repository are provided for educational purposes and workshop use. See [**LICENSE**](https://github.com/INN-SFU/tvb-node/blob/main/LICENSE) for details.
